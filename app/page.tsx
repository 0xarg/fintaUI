...
export default function () {
  return (
    <div className="flex flex-col items-center h-screen relative [background:radial-gradient(125%_100%_at_50%_0%,#FFF_6.32%,#E0F0FF_29.28%,#E7EFFD_68.68%,#FFF_100%)]">
      <div className="max-w-5xl mx-auto absolute insert-0 h-full w-full">
      ...
      <div className="absolute inset-x-0 left-0 h-px w-full bg-linear-to-r from-neutral-300/50 via-neutral-200 to-transparent pointer-events-none z-0 "/>
